...
OmBox.prototype = {
	...
	headerCreate: function() {
		...
		this.boxTop = doc.createElement("div");
		this.controlsWrap = doc.createElement("span");
		this.moveAbleWrap = doc.createElement("a");
		this.moveAbleWrap.href = "javascript:void(0)";
		this.titleElement = doc.createElement("h3");
		this.titleElement.innerHTML = this.title;
		
		//Create Buttons//
		//Delete Button
		if(this.deleteButton) {
			this.deleteButton = doc.createElement("a");
			this.deleteButton.href = "javascript:void(0)";
			this.controlsWrap.appendChild(this.deleteButton);
		}
		//FullSize Button
		if(this.fullSizeButton) {
			this.fullSizeButton = doc.createElement("a");
			this.fullSizeButton.href = "javascript:void(0)";
			this.controlsWrap.appendChild(this.fullSizeButton);
		}
		//OutButton 
		if(this.outButton) {
			this.outButton = doc.createElement("a");
	...
	footerCreate: function() {
		...
		this.resizeHandle = doc.createElement("a");
...
OmBox.prototype.parseCustomize = function(customize) {
	...
	var customs = [
		...
		"footer", "top", "overlay", "showDefault", "topMax"
	];
